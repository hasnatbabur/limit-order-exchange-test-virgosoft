                ...
                <div class="rounded-md shadow-sm -space-y-px">
                    <div>
                        ...
                        <input
                            ...
                            autocomplete="email"
                            required
                            class="appearance-none box-border rounded-none relative block w-full px-3 py-2.5 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm"
                    ...
                    <div>
                        ...
                        <input
                            ...
                            required
                            class="appearance-none box-border rounded-none relative block w-full px-3 py-2.5 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm"
